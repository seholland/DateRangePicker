...
public class CalendarPickerView extends ListView
{
	...
	ArrayList<Integer> deactivatedDays = new ArrayList<>();
	...
	public CalendarPickerView(Context context, AttributeSet attrs)
	{
		...
		dayTextColorResId = a.getResourceId(R.styleable.CalendarPickerView_tsquare_dayTextColor, R.drawable.day_text_color);
		titleTextColor = a.getColor(R.styleable.CalendarPickerView_tsquare_titleTextColor, res.getColor(R.color.dateTimeRangePickerTitleTextColor));
		displayHeader = a.getBoolean(R.styleable.CalendarPickerView_tsquare_displayHeader, true);
		headerTextColor = a.getColor(R.styleable.CalendarPickerView_tsquare_headerTextColor, res.getColor(R.color.dateTimeRangePickerHeaderTextColor));
		a.recycle();
	...
	public class FluentInitializer
	{
		 ...
		 */
		public FluentInitializer withDeactivatedDays(ArrayList<Integer> deactivatedDays)
		{
...
//			}
			...
			if(deactivatedDays.contains(day))
			{
				return;
			}
					...
					for(List<MonthCellDescriptor> week : month)
					{
						for(MonthCellDescriptor singleCell : week)
						{
							if(singleCell.getDate().after(start) && singleCell.getDate().before(end) && singleCell.isSelectable())
							{
								...
								else if(!deactivatedDays.contains(singleCell.getDate().getDay() + 1))
								{
	 ...
	 * @param deactivatedDays List of unavailable days of the week
	 */
	public void deactivateDays(ArrayList<Integer> deactivatedDays)
	{
	...
	private class MonthAdapter extends BaseAdapter
	{
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			...
			monthView.init(months.get(position), cells.getValueAtIndex(position), displayOnly, titleTypeface, dateTypeface, deactivatedDays);
			return monthView;
		}
	}
